...
// Filled in once the Polar products exist; until then Hearth runs as Free and
// says so plainly rather than pretending to check.
const POLAR_ORG_ID = process.env.HEARTH_POLAR_ORG_ID || '';
const BUY_URL = process.env.HEARTH_BUY_URL || '';
